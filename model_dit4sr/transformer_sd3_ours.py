...
from .attention_ours import JointTransformerBlock
...
class SD3Transformer2DModel(ModelMixin, ConfigMixin, PeftAdapterMixin, FromOriginalModelMixin):
    ...
    def __init__(
        ...
        is_full_attention_layers: Tuple[
            int, ...
        ] = (),  # () for default; (13~23) for Ours
        full_attn_mode = 'sequential',  # 'sequential' or 'parallel'
    ):
        super().__init__()
        ...
        self.transformer_blocks = nn.ModuleList(
            [
                JointTransformerBlock(
                    ...
                    is_full_attention=True if i in is_full_attention_layers else False,
                    full_attn_mode=full_attn_mode,
                )
