...
CUDA_VISIBLE_DEVICES=${IDX} python test/test_jaewon.py \
    ...
    --transformer_model_name_or_path="/mnt/dataset1/m_jaewon/icml26/DiT4SR/experiments/[Baseline]_ALLLayer_5e-5/checkpoint-100000" \
    ...
    --output_dir /mnt/dataset3/jaewon/eval/${DATASET}/DiT4SR_ours_all_layer_5e-5 \
