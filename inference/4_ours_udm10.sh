    ...
    CUDA_VISIBLE_DEVICES=${IDX} python test/test_jaewon.py \
        ...
        --output_dir /mnt/dataset2/jaewon/eval/${DATASET}/DiT4SR_ours_flow_${CHUNK}c${OVERLAP}_${WARP_START}_${WARP_END}w_${WARPING_MODE}_${FUSE_SCLAE}fs \
        --chunk_size ${CHUNK} \
        --overlap_size ${OVERLAP} \
        --warpping_start_step ${WARP_START} \
        --warpping_end_step ${WARP_END} \
        --fuse_scale ${FUSE_SCLAE} \
        --warping_mode ${WARPING_MODE}
