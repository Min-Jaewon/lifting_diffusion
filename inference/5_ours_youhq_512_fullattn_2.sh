    ...
    CUDA_VISIBLE_DEVICES=${IDX} python test/test_jaewon.py \
        ...
        --transformer_model_name_or_path="/mnt/dataset3/jaewon/_hanwha_weights/[Later]_Baseline_Flow/checkpoint-${CKP_POINT}/transformer" \
        ...
        --output_dir /mnt/dataset3/jaewon/eval/${DATASET}/DiT4SR_ours_fullattn_later_hanwha_Flow_${CKP_POINT} \
