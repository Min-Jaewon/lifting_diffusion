...
CUDA_VISIBLE_DEVICES=${IDX} python test/test_jaewon.py \
    ...
    --transformer_model_name_or_path="/mnt/dataset3/jaewon/_hanwha_weights/[Later]_Baseline/checkpoint-${CKP_POINT}" \
    ...
    --output_dir /mnt/dataset3/jaewon/eval/${DATASET}/DiT4SR_ours_fullattn_later_hanwha_${CKP_POINT} \
...
CUDA_VISIBLE_DEVICES=${IDX} python test/test_jaewon.py \
    ...
    --end_idx 3 \
    --pretrained_model_name_or_path="preset/models/stable-diffusion-3.5-medium" \
    --transformer_model_name_or_path="/mnt/dataset3/jaewon/_hanwha_weights/[Later]_Baseline_FullFT/checkpoint-${CKP_POINT}" \
    --raft_model_path="/mnt/dataset3/jaewon/_final_weights/laeyr_0_1_2_3/checkpoint-100000/raft_weights.pt" \
    --video_path /mnt/dataset3/jaewon/eval/${DATASET}/lq_videos \
    --prompt_path /mnt/dataset3/jaewon/eval/${DATASET}/prompts \
    --output_dir /mnt/dataset3/jaewon/eval/${DATASET}/DiT4SR_ours_fullattn_later_hanwha_fullft_${CKP_POINT} \
    --target_lifting_layer 16 17 18 19 20 21 22 23 \
    --chunk_size ${CHUNK} \
    --overlap_size ${OVERLAP}
